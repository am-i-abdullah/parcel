...
#define MQTT_BROKER_IP "10.7.233.217" // Your PC's IP address
...
void setup()
{
  ...
  if (!ledcAttach(ENA1, frequency, resolutionPWM))
  { // Corrected to ledcAttachPin
  ...
  if (!ledcAttach(ENA2, frequency, resolutionPWM))
  { // Corrected to ledcAttachPin
